...
public class AppTokenService {
    ...
    public static RequestBuilder<SessionInfo> startSession(String id, String tokenHash, String userId, int expiry)  {
        return startSession(id, tokenHash, userId, expiry, null);
    }

	/**  Starts a new KS (Kaltura Session) based on application authentication token id  */
    public static RequestBuilder<SessionInfo> startSession(String id, String tokenHash, String userId, int expiry, String udid)  {
        Params kparams = new Params();
        kparams.add("id", id);

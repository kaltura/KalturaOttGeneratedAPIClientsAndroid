...
public class AssetService {
    ...
    public static RequestBuilder<AdsContext> getAdsContext(String assetId, AssetType assetType, PlaybackContextOptions contextDataParams)  {
        Params kparams = new Params();
        kparams.add("assetId", assetId);
        kparams.add("assetType", assetType);
        kparams.add("contextDataParams", contextDataParams);

        return new RequestBuilder<AdsContext>(AdsContext.class, "asset", "getAdsContext", kparams);
    }

...
public class IngestProgramResultsByCombinedFieldsFilter extends IngestProgramResultsByRefineFilter {
    ...
    public static final Creator<IngestProgramResultsByCombinedFieldsFilter> CREATOR = new Creator<IngestProgramResultsByCombinedFieldsFilter>() {
        @Override
        public IngestProgramResultsByCombinedFieldsFilter createFromParcel(Parcel source) {
            return new IngestProgramResultsByCombinedFieldsFilter(source);
        }

        @Override
        public IngestProgramResultsByCombinedFieldsFilter[] newArray(int size) {
            return new IngestProgramResultsByCombinedFieldsFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.combinedFieldsValue);
    }

    public IngestProgramResultsByCombinedFieldsFilter(Parcel in) {
        super(in);
        this.combinedFieldsValue = in.readString();
    }
}

...
public class FilterFileByFileTypeIdInPlaybackAction extends FilterFileByFileTypeIdAction {
    ...
    public static final Creator<FilterFileByFileTypeIdInPlaybackAction> CREATOR = new Creator<FilterFileByFileTypeIdInPlaybackAction>() {
        @Override
        public FilterFileByFileTypeIdInPlaybackAction createFromParcel(Parcel source) {
            return new FilterFileByFileTypeIdInPlaybackAction(source);
        }

        @Override
        public FilterFileByFileTypeIdInPlaybackAction[] newArray(int size) {
            return new FilterFileByFileTypeIdInPlaybackAction[size];
        }
    };

    public FilterFileByFileTypeIdInPlaybackAction(Parcel in) {
        super(in);
    }
}

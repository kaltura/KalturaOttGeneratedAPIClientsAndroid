...
public abstract class FilterAction extends AssetRuleAction {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.preActionCondition, flags);
    }

    public FilterAction(Parcel in) {
        super(in);
        this.preActionCondition = in.readParcelable(BasePreActionCondition.class.getClassLoader());
    }
}

...
public class BulkUploadMediaEntryData extends BulkUploadAssetEntryData {
    ...
    public static final Creator<BulkUploadMediaEntryData> CREATOR = new Creator<BulkUploadMediaEntryData>() {
        @Override
        public BulkUploadMediaEntryData createFromParcel(Parcel source) {
            return new BulkUploadMediaEntryData(source);
        }

        @Override
        public BulkUploadMediaEntryData[] newArray(int size) {
            return new BulkUploadMediaEntryData[size];
        }
    };

    public BulkUploadMediaEntryData(Parcel in) {
        super(in);
    }
}

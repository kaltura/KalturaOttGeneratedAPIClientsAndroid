...
public class FilterFileByDynamicDataInPlaybackAction extends FilterFileByDynamicDataAction {
    ...
    public static final Creator<FilterFileByDynamicDataInPlaybackAction> CREATOR = new Creator<FilterFileByDynamicDataInPlaybackAction>() {
        @Override
        public FilterFileByDynamicDataInPlaybackAction createFromParcel(Parcel source) {
            return new FilterFileByDynamicDataInPlaybackAction(source);
        }

        @Override
        public FilterFileByDynamicDataInPlaybackAction[] newArray(int size) {
            return new FilterFileByDynamicDataInPlaybackAction[size];
        }
    };

    public FilterFileByDynamicDataInPlaybackAction(Parcel in) {
        super(in);
    }
}

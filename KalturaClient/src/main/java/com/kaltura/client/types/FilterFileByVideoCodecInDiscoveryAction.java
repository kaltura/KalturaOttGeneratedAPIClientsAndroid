...
public class FilterFileByVideoCodecInDiscoveryAction extends FilterFileByVideoCodecAction {
    ...
    public static final Creator<FilterFileByVideoCodecInDiscoveryAction> CREATOR = new Creator<FilterFileByVideoCodecInDiscoveryAction>() {
        @Override
        public FilterFileByVideoCodecInDiscoveryAction createFromParcel(Parcel source) {
            return new FilterFileByVideoCodecInDiscoveryAction(source);
        }

        @Override
        public FilterFileByVideoCodecInDiscoveryAction[] newArray(int size) {
            return new FilterFileByVideoCodecInDiscoveryAction[size];
        }
    };

    public FilterFileByVideoCodecInDiscoveryAction(Parcel in) {
        super(in);
    }
}

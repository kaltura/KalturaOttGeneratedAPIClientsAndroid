...
public class RetryDeleteRequest extends ObjectBase {
    ...
    public static final Creator<RetryDeleteRequest> CREATOR = new Creator<RetryDeleteRequest>() {
        @Override
        public RetryDeleteRequest createFromParcel(Parcel source) {
            return new RetryDeleteRequest(source);
        }

        @Override
        public RetryDeleteRequest[] newArray(int size) {
            return new RetryDeleteRequest[size];
        }
    };
    ...
    public RetryDeleteRequest(Parcel in) {
        super(in);

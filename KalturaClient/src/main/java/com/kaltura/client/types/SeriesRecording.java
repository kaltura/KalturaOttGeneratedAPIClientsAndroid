...
public class SeriesRecording extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.householdSpecificSeriesStartTimeOffset);
        dest.writeValue(this.householdSpecificSeriesEndTimeOffset);
    }
    ...
    public SeriesRecording(Parcel in) {
        ...
        this.householdSpecificSeriesStartTimeOffset = (Integer)in.readValue(Integer.class.getClassLoader());
        this.householdSpecificSeriesEndTimeOffset = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}

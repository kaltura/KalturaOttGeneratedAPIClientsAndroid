...
public class SearchAssetListFilter extends SearchAssetFilter {
    ...
    public static final Creator<SearchAssetListFilter> CREATOR = new Creator<SearchAssetListFilter>() {
        @Override
        public SearchAssetListFilter createFromParcel(Parcel source) {
            return new SearchAssetListFilter(source);
        }

        @Override
        public SearchAssetListFilter[] newArray(int size) {
            return new SearchAssetListFilter[size];
        }
    };
    ...
    public SearchAssetListFilter(Parcel in) {
        super(in);

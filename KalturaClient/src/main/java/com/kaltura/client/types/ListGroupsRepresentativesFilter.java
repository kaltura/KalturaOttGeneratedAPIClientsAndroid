...
public class ListGroupsRepresentativesFilter extends Filter {
    ...
    public static final Creator<ListGroupsRepresentativesFilter> CREATOR = new Creator<ListGroupsRepresentativesFilter>() {
        @Override
        public ListGroupsRepresentativesFilter createFromParcel(Parcel source) {
            return new ListGroupsRepresentativesFilter(source);
        }

        @Override
        public ListGroupsRepresentativesFilter[] newArray(int size) {
            return new ListGroupsRepresentativesFilter[size];
        }
    };
    ...
    public ListGroupsRepresentativesFilter(Parcel in) {
        super(in);

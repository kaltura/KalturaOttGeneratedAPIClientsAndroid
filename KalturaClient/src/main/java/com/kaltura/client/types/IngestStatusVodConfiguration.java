...
public class IngestStatusVodConfiguration extends ObjectBase {
    ...
    public static final Creator<IngestStatusVodConfiguration> CREATOR = new Creator<IngestStatusVodConfiguration>() {
        @Override
        public IngestStatusVodConfiguration createFromParcel(Parcel source) {
            return new IngestStatusVodConfiguration(source);
        }

        @Override
        public IngestStatusVodConfiguration[] newArray(int size) {
            return new IngestStatusVodConfiguration[size];
        }
    };
    ...
    public IngestStatusVodConfiguration(Parcel in) {
        super(in);

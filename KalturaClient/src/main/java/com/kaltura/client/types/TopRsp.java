...
public class TopRsp extends RepresentativeSelectionPolicy {
    ...
    public static final Creator<TopRsp> CREATOR = new Creator<TopRsp>() {
        @Override
        public TopRsp createFromParcel(Parcel source) {
            return new TopRsp(source);
        }

        @Override
        public TopRsp[] newArray(int size) {
            return new TopRsp[size];
        }
    };

...
public class CatalogPartnerConfig extends PartnerConfiguration {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.shopMarkerMetaId);
    }
    ...
    public CatalogPartnerConfig(Parcel in) {
        ...
        this.uploadExportDatalake = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.shopMarkerMetaId = (Long)in.readValue(Long.class.getClassLoader());
    }
}

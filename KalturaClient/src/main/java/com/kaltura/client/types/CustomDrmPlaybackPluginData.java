...
public class CustomDrmPlaybackPluginData extends DrmPlaybackPluginData {
    ...
    public static final Creator<CustomDrmPlaybackPluginData> CREATOR = new Creator<CustomDrmPlaybackPluginData>() {
        @Override
        public CustomDrmPlaybackPluginData createFromParcel(Parcel source) {
            return new CustomDrmPlaybackPluginData(source);
        }

        @Override
        public CustomDrmPlaybackPluginData[] newArray(int size) {
            return new CustomDrmPlaybackPluginData[size];
        }
    };
    ...
    public CustomDrmPlaybackPluginData(Parcel in) {
        super(in);

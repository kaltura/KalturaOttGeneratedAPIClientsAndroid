...
public class AudioLanguageConstraint extends BaseAttributeConstraint {
    ...
    public static final Creator<AudioLanguageConstraint> CREATOR = new Creator<AudioLanguageConstraint>() {
        @Override
        public AudioLanguageConstraint createFromParcel(Parcel source) {
            return new AudioLanguageConstraint(source);
        }

        @Override
        public AudioLanguageConstraint[] newArray(int size) {
            return new AudioLanguageConstraint[size];
        }
    };
    ...
    public AudioLanguageConstraint(Parcel in) {
        super(in);

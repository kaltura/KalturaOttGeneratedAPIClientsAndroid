...
public class AssetHistorySuppressFilter extends RelatedObjectFilter {
    ...
    public static final Creator<AssetHistorySuppressFilter> CREATOR = new Creator<AssetHistorySuppressFilter>() {
        @Override
        public AssetHistorySuppressFilter createFromParcel(Parcel source) {
            return new AssetHistorySuppressFilter(source);
        }

        @Override
        public AssetHistorySuppressFilter[] newArray(int size) {
            return new AssetHistorySuppressFilter[size];
        }
    };

    public AssetHistorySuppressFilter(Parcel in) {
        super(in);
    }
}

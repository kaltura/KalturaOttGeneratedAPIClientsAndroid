...
public class ChannelDynamicOrder extends BaseChannelOrder {
    ...
    public static final Creator<ChannelDynamicOrder> CREATOR = new Creator<ChannelDynamicOrder>() {
        @Override
        public ChannelDynamicOrder createFromParcel(Parcel source) {
            return new ChannelDynamicOrder(source);
        }

        @Override
        public ChannelDynamicOrder[] newArray(int size) {
            return new ChannelDynamicOrder[size];
        }
    };
    ...
    public ChannelDynamicOrder(Parcel in) {
        super(in);

...
public class SegmentationType extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.conditionsOperator == null ? -1 : this.conditionsOperator.ordinal());
    ...
    public SegmentationType(Parcel in) {
        ...
        int tmpConditionsOperator = in.readInt();
        this.conditionsOperator = tmpConditionsOperator == -1 ? null : BooleanOperator.values()[tmpConditionsOperator];

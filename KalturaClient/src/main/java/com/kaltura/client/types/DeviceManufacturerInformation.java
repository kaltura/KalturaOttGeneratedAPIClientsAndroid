...
public class DeviceManufacturerInformation extends DeviceReferenceData {
    ...
    public static final Creator<DeviceManufacturerInformation> CREATOR = new Creator<DeviceManufacturerInformation>() {
        @Override
        public DeviceManufacturerInformation createFromParcel(Parcel source) {
            return new DeviceManufacturerInformation(source);
        }

        @Override
        public DeviceManufacturerInformation[] newArray(int size) {
            return new DeviceManufacturerInformation[size];
        }
    };

    public DeviceManufacturerInformation(Parcel in) {
        super(in);
    }
}

...
public class AssetDynamicOrder extends BaseAssetOrder {
    ...
    public static final Creator<AssetDynamicOrder> CREATOR = new Creator<AssetDynamicOrder>() {
        @Override
        public AssetDynamicOrder createFromParcel(Parcel source) {
            return new AssetDynamicOrder(source);
        }

        @Override
        public AssetDynamicOrder[] newArray(int size) {
            return new AssetDynamicOrder[size];
        }
    };
    ...
    public AssetDynamicOrder(Parcel in) {
        super(in);

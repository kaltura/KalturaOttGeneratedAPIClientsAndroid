...
public class SearchPriorityGroup extends ObjectBase {
    ...
    public static final Creator<SearchPriorityGroup> CREATOR = new Creator<SearchPriorityGroup>() {
        @Override
        public SearchPriorityGroup createFromParcel(Parcel source) {
            return new SearchPriorityGroup(source);
        }

        @Override
        public SearchPriorityGroup[] newArray(int size) {
            return new SearchPriorityGroup[size];
        }
    };
    ...
    public SearchPriorityGroup(Parcel in) {
        super(in);
        ...
        this.criteria = in.readParcelable(SearchPriorityCriteria.class.getClassLoader());
    }
}

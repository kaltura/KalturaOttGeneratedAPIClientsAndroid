...
public class SegmentSource extends ObjectBase {
    ...
    public static final Creator<SegmentSource> CREATOR = new Creator<SegmentSource>() {
        @Override
        public SegmentSource createFromParcel(Parcel source) {
            return new SegmentSource(source);
        }

        @Override
        public SegmentSource[] newArray(int size) {
            return new SegmentSource[size];
        }
    };

    public SegmentSource(Parcel in) {
        super(in);
    }
}

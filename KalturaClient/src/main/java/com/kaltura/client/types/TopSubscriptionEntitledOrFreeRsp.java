...
public class TopSubscriptionEntitledOrFreeRsp extends RepresentativeSelectionPolicy {
    ...
    public static final Creator<TopSubscriptionEntitledOrFreeRsp> CREATOR = new Creator<TopSubscriptionEntitledOrFreeRsp>() {
        @Override
        public TopSubscriptionEntitledOrFreeRsp createFromParcel(Parcel source) {
            return new TopSubscriptionEntitledOrFreeRsp(source);
        }

        @Override
        public TopSubscriptionEntitledOrFreeRsp[] newArray(int size) {
            return new TopSubscriptionEntitledOrFreeRsp[size];
        }
    };
    ...
    public TopSubscriptionEntitledOrFreeRsp(Parcel in) {
        super(in);

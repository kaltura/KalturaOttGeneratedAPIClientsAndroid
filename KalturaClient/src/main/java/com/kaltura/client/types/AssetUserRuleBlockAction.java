...
public class AssetUserRuleBlockAction extends AssetUserRuleAction {
    ...
    public static final Creator<AssetUserRuleBlockAction> CREATOR = new Creator<AssetUserRuleBlockAction>() {
        @Override
        public AssetUserRuleBlockAction createFromParcel(Parcel source) {
            return new AssetUserRuleBlockAction(source);
        }

        @Override
        public AssetUserRuleBlockAction[] newArray(int size) {
            return new AssetUserRuleBlockAction[size];
        }
    };

    public AssetUserRuleBlockAction(Parcel in) {
        super(in);
    }
}

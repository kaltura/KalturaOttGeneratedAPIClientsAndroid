...
public class HouseholdPartnerConfiguration extends ObjectBase {
    ...
    public static final Creator<HouseholdPartnerConfiguration> CREATOR = new Creator<HouseholdPartnerConfiguration>() {
        @Override
        public HouseholdPartnerConfiguration createFromParcel(Parcel source) {
            return new HouseholdPartnerConfiguration(source);
        }

        @Override
        public HouseholdPartnerConfiguration[] newArray(int size) {
            return new HouseholdPartnerConfiguration[size];
        }
    };
    ...
    public HouseholdPartnerConfiguration(Parcel in) {
        super(in);

...
public class FilterFileByLabelInDiscoveryAction extends FilterFileByLabelAction {
    ...
    public static final Creator<FilterFileByLabelInDiscoveryAction> CREATOR = new Creator<FilterFileByLabelInDiscoveryAction>() {
        @Override
        public FilterFileByLabelInDiscoveryAction createFromParcel(Parcel source) {
            return new FilterFileByLabelInDiscoveryAction(source);
        }

        @Override
        public FilterFileByLabelInDiscoveryAction[] newArray(int size) {
            return new FilterFileByLabelInDiscoveryAction[size];
        }
    };

    public FilterFileByLabelInDiscoveryAction(Parcel in) {
        super(in);
    }
}

...
public class DynamicListIdInFilter extends DynamicListFilter {
    ...
    public static final Creator<DynamicListIdInFilter> CREATOR = new Creator<DynamicListIdInFilter>() {
        @Override
        public DynamicListIdInFilter createFromParcel(Parcel source) {
            return new DynamicListIdInFilter(source);
        }

        @Override
        public DynamicListIdInFilter[] newArray(int size) {
            return new DynamicListIdInFilter[size];
        }
    };
    ...
    public DynamicListIdInFilter(Parcel in) {
        super(in);

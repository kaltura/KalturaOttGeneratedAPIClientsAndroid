...
public class FilterFileByStreamerTypeInDiscovery extends FilterFileByStreamerTypeAction {
    ...
    public static final Creator<FilterFileByStreamerTypeInDiscovery> CREATOR = new Creator<FilterFileByStreamerTypeInDiscovery>() {
        @Override
        public FilterFileByStreamerTypeInDiscovery createFromParcel(Parcel source) {
            return new FilterFileByStreamerTypeInDiscovery(source);
        }

        @Override
        public FilterFileByStreamerTypeInDiscovery[] newArray(int size) {
            return new FilterFileByStreamerTypeInDiscovery[size];
        }
    };

    public FilterFileByStreamerTypeInDiscovery(Parcel in) {
        super(in);
    }
}

...
public class ProgramSearchableAttributes extends ObjectBase {
    ...
    public static final Creator<ProgramSearchableAttributes> CREATOR = new Creator<ProgramSearchableAttributes>() {
        @Override
        public ProgramSearchableAttributes createFromParcel(Parcel source) {
            return new ProgramSearchableAttributes(source);
        }

        @Override
        public ProgramSearchableAttributes[] newArray(int size) {
            return new ProgramSearchableAttributes[size];
        }
    };
    ...
    public ProgramSearchableAttributes(Parcel in) {
        super(in);

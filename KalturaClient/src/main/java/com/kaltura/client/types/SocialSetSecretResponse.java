...
public class SocialSetSecretResponse extends ObjectBase {
    ...
    public static final Creator<SocialSetSecretResponse> CREATOR = new Creator<SocialSetSecretResponse>() {
        @Override
        public SocialSetSecretResponse createFromParcel(Parcel source) {
            return new SocialSetSecretResponse(source);
        }

        @Override
        public SocialSetSecretResponse[] newArray(int size) {
            return new SocialSetSecretResponse[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.secretSet);
    }

    public SocialSetSecretResponse(Parcel in) {
        super(in);
        this.secretSet = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}

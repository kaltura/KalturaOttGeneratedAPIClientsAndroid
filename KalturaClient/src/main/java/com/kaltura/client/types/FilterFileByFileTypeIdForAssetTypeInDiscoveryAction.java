...
public class FilterFileByFileTypeIdForAssetTypeInDiscoveryAction extends FilterFileByFileTypeIdForAssetTypeAction {
    ...
    public static final Creator<FilterFileByFileTypeIdForAssetTypeInDiscoveryAction> CREATOR = new Creator<FilterFileByFileTypeIdForAssetTypeInDiscoveryAction>() {
        @Override
        public FilterFileByFileTypeIdForAssetTypeInDiscoveryAction createFromParcel(Parcel source) {
            return new FilterFileByFileTypeIdForAssetTypeInDiscoveryAction(source);
        }

        @Override
        public FilterFileByFileTypeIdForAssetTypeInDiscoveryAction[] newArray(int size) {
            return new FilterFileByFileTypeIdForAssetTypeInDiscoveryAction[size];
        }
    };

    public FilterFileByFileTypeIdForAssetTypeInDiscoveryAction(Parcel in) {
        super(in);
    }
}

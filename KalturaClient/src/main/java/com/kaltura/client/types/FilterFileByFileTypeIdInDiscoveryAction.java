...
public class FilterFileByFileTypeIdInDiscoveryAction extends FilterFileByFileTypeIdAction {
    ...
    public static final Creator<FilterFileByFileTypeIdInDiscoveryAction> CREATOR = new Creator<FilterFileByFileTypeIdInDiscoveryAction>() {
        @Override
        public FilterFileByFileTypeIdInDiscoveryAction createFromParcel(Parcel source) {
            return new FilterFileByFileTypeIdInDiscoveryAction(source);
        }

        @Override
        public FilterFileByFileTypeIdInDiscoveryAction[] newArray(int size) {
            return new FilterFileByFileTypeIdInDiscoveryAction[size];
        }
    };

    public FilterFileByFileTypeIdInDiscoveryAction(Parcel in) {
        super(in);
    }
}

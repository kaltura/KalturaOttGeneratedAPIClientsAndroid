...
public class CampaignEntitlementDiscountDetails extends EntitlementDiscountDetailsIdentifier {
    ...
    public static final Creator<CampaignEntitlementDiscountDetails> CREATOR = new Creator<CampaignEntitlementDiscountDetails>() {
        @Override
        public CampaignEntitlementDiscountDetails createFromParcel(Parcel source) {
            return new CampaignEntitlementDiscountDetails(source);
        }

        @Override
        public CampaignEntitlementDiscountDetails[] newArray(int size) {
            return new CampaignEntitlementDiscountDetails[size];
        }
    };

    public CampaignEntitlementDiscountDetails(Parcel in) {
        super(in);
    }
}

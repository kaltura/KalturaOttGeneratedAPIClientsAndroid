...
public class SocialServiceId extends ObjectBase {
    ...
    public static final Creator<SocialServiceId> CREATOR = new Creator<SocialServiceId>() {
        @Override
        public SocialServiceId createFromParcel(Parcel source) {
            return new SocialServiceId(source);
        }

        @Override
        public SocialServiceId[] newArray(int size) {
            return new SocialServiceId[size];
        }
    };
    ...
    public SocialServiceId(Parcel in) {
        super(in);

...
public class TimeShiftedTvPartnerSettings extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.defaultQuota);
        dest.writeValue(this.personalizedRecording);
        dest.writeValue(this.maxRecordingConcurrency);
        dest.writeValue(this.maxConcurrencyMargin);
        dest.writeValue(this.shouldRoundStopRecordingsBySeconds);
    }
    ...
    public TimeShiftedTvPartnerSettings(Parcel in) {
        ...
        this.defaultQuota = (Integer)in.readValue(Integer.class.getClassLoader());
        this.personalizedRecording = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.maxRecordingConcurrency = (Integer)in.readValue(Integer.class.getClassLoader());
        this.maxConcurrencyMargin = (Integer)in.readValue(Integer.class.getClassLoader());
        this.shouldRoundStopRecordingsBySeconds = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}

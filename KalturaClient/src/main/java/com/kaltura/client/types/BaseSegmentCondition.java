...
public class BaseSegmentCondition extends ObjectBase {
    ...
    public static final Creator<BaseSegmentCondition> CREATOR = new Creator<BaseSegmentCondition>() {
        @Override
        public BaseSegmentCondition createFromParcel(Parcel source) {
            return new BaseSegmentCondition(source);
        }

        @Override
        public BaseSegmentCondition[] newArray(int size) {
            return new BaseSegmentCondition[size];
        }
    };

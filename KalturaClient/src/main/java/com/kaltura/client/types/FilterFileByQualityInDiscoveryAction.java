...
public class FilterFileByQualityInDiscoveryAction extends FilterFileByQualityAction {
    ...
    public static final Creator<FilterFileByQualityInDiscoveryAction> CREATOR = new Creator<FilterFileByQualityInDiscoveryAction>() {
        @Override
        public FilterFileByQualityInDiscoveryAction createFromParcel(Parcel source) {
            return new FilterFileByQualityInDiscoveryAction(source);
        }

        @Override
        public FilterFileByQualityInDiscoveryAction[] newArray(int size) {
            return new FilterFileByQualityInDiscoveryAction[size];
        }
    };

    public FilterFileByQualityInDiscoveryAction(Parcel in) {
        super(in);
    }
}

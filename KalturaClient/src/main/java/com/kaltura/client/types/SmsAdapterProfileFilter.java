...
public class SmsAdapterProfileFilter extends CrudFilter {
    ...
    public static final Creator<SmsAdapterProfileFilter> CREATOR = new Creator<SmsAdapterProfileFilter>() {
        @Override
        public SmsAdapterProfileFilter createFromParcel(Parcel source) {
            return new SmsAdapterProfileFilter(source);
        }

        @Override
        public SmsAdapterProfileFilter[] newArray(int size) {
            return new SmsAdapterProfileFilter[size];
        }
    };

    public SmsAdapterProfileFilter(Parcel in) {
        super(in);
    }
}

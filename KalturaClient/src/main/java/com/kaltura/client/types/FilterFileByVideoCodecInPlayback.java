...
public class FilterFileByVideoCodecInPlayback extends FilterFileByVideoCodecAction {
    ...
    public static final Creator<FilterFileByVideoCodecInPlayback> CREATOR = new Creator<FilterFileByVideoCodecInPlayback>() {
        @Override
        public FilterFileByVideoCodecInPlayback createFromParcel(Parcel source) {
            return new FilterFileByVideoCodecInPlayback(source);
        }

        @Override
        public FilterFileByVideoCodecInPlayback[] newArray(int size) {
            return new FilterFileByVideoCodecInPlayback[size];
        }
    };

    public FilterFileByVideoCodecInPlayback(Parcel in) {
        super(in);
    }
}

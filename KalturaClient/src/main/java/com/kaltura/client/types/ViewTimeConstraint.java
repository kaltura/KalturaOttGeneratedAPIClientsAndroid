...
public class ViewTimeConstraint extends ObjectBase {
    ...
    public static final Creator<ViewTimeConstraint> CREATOR = new Creator<ViewTimeConstraint>() {
        @Override
        public ViewTimeConstraint createFromParcel(Parcel source) {
            return new ViewTimeConstraint(source);
        }

        @Override
        public ViewTimeConstraint[] newArray(int size) {
            return new ViewTimeConstraint[size];
        }
    };
    ...
    public ViewTimeConstraint(Parcel in) {
        super(in);

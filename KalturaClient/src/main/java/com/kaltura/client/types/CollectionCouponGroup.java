...
public class CollectionCouponGroup extends ObjectBase {
    ...
    public static final Creator<CollectionCouponGroup> CREATOR = new Creator<CollectionCouponGroup>() {
        @Override
        public CollectionCouponGroup createFromParcel(Parcel source) {
            return new CollectionCouponGroup(source);
        }

        @Override
        public CollectionCouponGroup[] newArray(int size) {
            return new CollectionCouponGroup[size];
        }
    };
    ...
    public CollectionCouponGroup(Parcel in) {
        super(in);

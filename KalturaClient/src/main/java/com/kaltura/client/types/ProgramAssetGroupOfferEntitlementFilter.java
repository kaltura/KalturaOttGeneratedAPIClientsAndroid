...
public class ProgramAssetGroupOfferEntitlementFilter extends EntitlementFilter {
    ...
    public static final Creator<ProgramAssetGroupOfferEntitlementFilter> CREATOR = new Creator<ProgramAssetGroupOfferEntitlementFilter>() {
        @Override
        public ProgramAssetGroupOfferEntitlementFilter createFromParcel(Parcel source) {
            return new ProgramAssetGroupOfferEntitlementFilter(source);
        }

        @Override
        public ProgramAssetGroupOfferEntitlementFilter[] newArray(int size) {
            return new ProgramAssetGroupOfferEntitlementFilter[size];
        }
    };

    public ProgramAssetGroupOfferEntitlementFilter(Parcel in) {
        super(in);
    }
}

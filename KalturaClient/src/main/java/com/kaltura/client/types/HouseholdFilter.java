...
public class HouseholdFilter extends Filter {
    ...
    public static final Creator<HouseholdFilter> CREATOR = new Creator<HouseholdFilter>() {
        @Override
        public HouseholdFilter createFromParcel(Parcel source) {
            return new HouseholdFilter(source);
        }

        @Override
        public HouseholdFilter[] newArray(int size) {
            return new HouseholdFilter[size];
        }
    };
    ...
    public HouseholdFilter(Parcel in) {
        super(in);

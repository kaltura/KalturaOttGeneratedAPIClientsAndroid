...
public class ChannelCondition extends Condition {
    ...
    public static final Creator<ChannelCondition> CREATOR = new Creator<ChannelCondition>() {
        @Override
        public ChannelCondition createFromParcel(Parcel source) {
            return new ChannelCondition(source);
        }

        @Override
        public ChannelCondition[] newArray(int size) {
            return new ChannelCondition[size];
        }
    };
    ...
    public ChannelCondition(Parcel in) {
        super(in);

...
public class ProgramAssetGroupOfferIdInFilter extends ProgramAssetGroupOfferFilter {
    ...
    public static final Creator<ProgramAssetGroupOfferIdInFilter> CREATOR = new Creator<ProgramAssetGroupOfferIdInFilter>() {
        @Override
        public ProgramAssetGroupOfferIdInFilter createFromParcel(Parcel source) {
            return new ProgramAssetGroupOfferIdInFilter(source);
        }

        @Override
        public ProgramAssetGroupOfferIdInFilter[] newArray(int size) {
            return new ProgramAssetGroupOfferIdInFilter[size];
        }
    };
    ...
    public ProgramAssetGroupOfferIdInFilter(Parcel in) {
        super(in);

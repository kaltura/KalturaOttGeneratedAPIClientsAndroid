...
public class BulkUploadUdidDynamicListResult extends BulkUploadDynamicListResult {
    ...
    public static final Creator<BulkUploadUdidDynamicListResult> CREATOR = new Creator<BulkUploadUdidDynamicListResult>() {
        @Override
        public BulkUploadUdidDynamicListResult createFromParcel(Parcel source) {
            return new BulkUploadUdidDynamicListResult(source);
        }

        @Override
        public BulkUploadUdidDynamicListResult[] newArray(int size) {
            return new BulkUploadUdidDynamicListResult[size];
        }
    };
    ...
    public BulkUploadUdidDynamicListResult(Parcel in) {
        super(in);

...
public class CouponPromotion extends BasePromotion {
    ...
    public static final Creator<CouponPromotion> CREATOR = new Creator<CouponPromotion>() {
        @Override
        public CouponPromotion createFromParcel(Parcel source) {
            return new CouponPromotion(source);
        }

        @Override
        public CouponPromotion[] newArray(int size) {
            return new CouponPromotion[size];
        }
    };
    ...
    public CouponPromotion(Parcel in) {
        super(in);
        this.couponGroupId = (Long)in.readValue(Long.class.getClassLoader());
    }
}

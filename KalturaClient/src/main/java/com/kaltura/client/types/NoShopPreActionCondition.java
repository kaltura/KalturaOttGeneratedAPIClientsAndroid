...
public class NoShopPreActionCondition extends BasePreActionCondition {
    ...
    public static final Creator<NoShopPreActionCondition> CREATOR = new Creator<NoShopPreActionCondition>() {
        @Override
        public NoShopPreActionCondition createFromParcel(Parcel source) {
            return new NoShopPreActionCondition(source);
        }

        @Override
        public NoShopPreActionCondition[] newArray(int size) {
            return new NoShopPreActionCondition[size];
        }
    };

    public NoShopPreActionCondition(Parcel in) {
        super(in);
    }
}

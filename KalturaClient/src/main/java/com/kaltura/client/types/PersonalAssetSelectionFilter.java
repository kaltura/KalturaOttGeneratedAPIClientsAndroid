...
public class PersonalAssetSelectionFilter extends Filter {
    ...
    public static final Creator<PersonalAssetSelectionFilter> CREATOR = new Creator<PersonalAssetSelectionFilter>() {
        @Override
        public PersonalAssetSelectionFilter createFromParcel(Parcel source) {
            return new PersonalAssetSelectionFilter(source);
        }

        @Override
        public PersonalAssetSelectionFilter[] newArray(int size) {
            return new PersonalAssetSelectionFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.slotNumberEqual);
    }

    public PersonalAssetSelectionFilter(Parcel in) {
        super(in);
        this.slotNumberEqual = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}

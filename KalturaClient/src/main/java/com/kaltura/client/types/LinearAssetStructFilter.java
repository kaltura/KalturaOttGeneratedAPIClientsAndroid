...
public class LinearAssetStructFilter extends BaseAssetStructFilter {
    ...
    public static final Creator<LinearAssetStructFilter> CREATOR = new Creator<LinearAssetStructFilter>() {
        @Override
        public LinearAssetStructFilter createFromParcel(Parcel source) {
            return new LinearAssetStructFilter(source);
        }

        @Override
        public LinearAssetStructFilter[] newArray(int size) {
            return new LinearAssetStructFilter[size];
        }
    };

    public LinearAssetStructFilter(Parcel in) {
        super(in);
    }
}

...
public class AssetEvent extends EventObject {
    ...
    public static final Creator<AssetEvent> CREATOR = new Creator<AssetEvent>() {
        @Override
        public AssetEvent createFromParcel(Parcel source) {
            return new AssetEvent(source);
        }

        @Override
        public AssetEvent[] newArray(int size) {
            return new AssetEvent[size];
        }
    };

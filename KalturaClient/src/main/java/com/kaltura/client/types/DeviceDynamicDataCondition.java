...
public class DeviceDynamicDataCondition extends Condition {
    ...
    public static final Creator<DeviceDynamicDataCondition> CREATOR = new Creator<DeviceDynamicDataCondition>() {
        @Override
        public DeviceDynamicDataCondition createFromParcel(Parcel source) {
            return new DeviceDynamicDataCondition(source);
        }

        @Override
        public DeviceDynamicDataCondition[] newArray(int size) {
            return new DeviceDynamicDataCondition[size];
        }
    };
    ...
    public DeviceDynamicDataCondition(Parcel in) {
        super(in);

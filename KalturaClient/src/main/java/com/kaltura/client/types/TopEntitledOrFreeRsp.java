...
public class TopEntitledOrFreeRsp extends RepresentativeSelectionPolicy {
    ...
    public static final Creator<TopEntitledOrFreeRsp> CREATOR = new Creator<TopEntitledOrFreeRsp>() {
        @Override
        public TopEntitledOrFreeRsp createFromParcel(Parcel source) {
            return new TopEntitledOrFreeRsp(source);
        }

        @Override
        public TopEntitledOrFreeRsp[] newArray(int size) {
            return new TopEntitledOrFreeRsp[size];
        }
    };
    ...
    public TopEntitledOrFreeRsp(Parcel in) {
        super(in);

...
public class PermissionItemByIdInFilter extends PermissionItemFilter {
    ...
    public static final Creator<PermissionItemByIdInFilter> CREATOR = new Creator<PermissionItemByIdInFilter>() {
        @Override
        public PermissionItemByIdInFilter createFromParcel(Parcel source) {
            return new PermissionItemByIdInFilter(source);
        }

        @Override
        public PermissionItemByIdInFilter[] newArray(int size) {
            return new PermissionItemByIdInFilter[size];
        }
    };
    ...
    public PermissionItemByIdInFilter(Parcel in) {
        super(in);

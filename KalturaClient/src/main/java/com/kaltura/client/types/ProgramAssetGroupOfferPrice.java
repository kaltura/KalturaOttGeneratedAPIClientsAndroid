...
public class ProgramAssetGroupOfferPrice extends ProductPrice {
    ...
    public static final Creator<ProgramAssetGroupOfferPrice> CREATOR = new Creator<ProgramAssetGroupOfferPrice>() {
        @Override
        public ProgramAssetGroupOfferPrice createFromParcel(Parcel source) {
            return new ProgramAssetGroupOfferPrice(source);
        }

        @Override
        public ProgramAssetGroupOfferPrice[] newArray(int size) {
            return new ProgramAssetGroupOfferPrice[size];
        }
    };

    public ProgramAssetGroupOfferPrice(Parcel in) {
        super(in);
    }
}

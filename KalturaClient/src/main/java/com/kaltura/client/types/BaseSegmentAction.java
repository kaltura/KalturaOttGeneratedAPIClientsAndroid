...
public class BaseSegmentAction extends ObjectBase {
    ...
    public static final Creator<BaseSegmentAction> CREATOR = new Creator<BaseSegmentAction>() {
        @Override
        public BaseSegmentAction createFromParcel(Parcel source) {
            return new BaseSegmentAction(source);
        }

        @Override
        public BaseSegmentAction[] newArray(int size) {
            return new BaseSegmentAction[size];
        }
    };

    public BaseSegmentAction(Parcel in) {
        super(in);
    }
}

...
public class PublicCouponGenerationOptions extends CouponGenerationOptions {
    ...
    public static final Creator<PublicCouponGenerationOptions> CREATOR = new Creator<PublicCouponGenerationOptions>() {
        @Override
        public PublicCouponGenerationOptions createFromParcel(Parcel source) {
            return new PublicCouponGenerationOptions(source);
        }

        @Override
        public PublicCouponGenerationOptions[] newArray(int size) {
            return new PublicCouponGenerationOptions[size];
        }
    };
    ...
    public PublicCouponGenerationOptions(Parcel in) {
        super(in);

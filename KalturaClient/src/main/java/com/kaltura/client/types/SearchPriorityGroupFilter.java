...
public class SearchPriorityGroupFilter extends Filter {
    ...
    public static final Creator<SearchPriorityGroupFilter> CREATOR = new Creator<SearchPriorityGroupFilter>() {
        @Override
        public SearchPriorityGroupFilter createFromParcel(Parcel source) {
            return new SearchPriorityGroupFilter(source);
        }

        @Override
        public SearchPriorityGroupFilter[] newArray(int size) {
            return new SearchPriorityGroupFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.activeOnlyEqual);
        dest.writeValue(this.idEqual);
    }

    public SearchPriorityGroupFilter(Parcel in) {
        super(in);
        this.activeOnlyEqual = (Boolean)in.readValue(Boolean.class.getClassLoader());

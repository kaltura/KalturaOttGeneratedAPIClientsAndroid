...
public class AssetSubscriptionCondition extends SubscriptionCondition {
    ...
    public static final Creator<AssetSubscriptionCondition> CREATOR = new Creator<AssetSubscriptionCondition>() {
        @Override
        public AssetSubscriptionCondition createFromParcel(Parcel source) {
            return new AssetSubscriptionCondition(source);
        }

        @Override
        public AssetSubscriptionCondition[] newArray(int size) {
            return new AssetSubscriptionCondition[size];
        }
    };

    public AssetSubscriptionCondition(Parcel in) {
        super(in);
    }
}

...
public class CognitoUserPool extends ObjectBase {
    ...
    public static final Creator<CognitoUserPool> CREATOR = new Creator<CognitoUserPool>() {
        @Override
        public CognitoUserPool createFromParcel(Parcel source) {
            return new CognitoUserPool(source);
        }

        @Override
        public CognitoUserPool[] newArray(int size) {
            return new CognitoUserPool[size];
        }
    };
    ...
    public CognitoUserPool(Parcel in) {
        super(in);

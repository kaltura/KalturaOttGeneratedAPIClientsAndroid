...
public class StreamingDevice extends ObjectBase {
    ...
    public static final Creator<StreamingDevice> CREATOR = new Creator<StreamingDevice>() {
        @Override
        public StreamingDevice createFromParcel(Parcel source) {
            return new StreamingDevice(source);
        }

        @Override
        public StreamingDevice[] newArray(int size) {
            return new StreamingDevice[size];
        }
    };
    ...
    public StreamingDevice(Parcel in) {
        super(in);
        this.asset = in.readParcelable(SlimAsset.class.getClassLoader());

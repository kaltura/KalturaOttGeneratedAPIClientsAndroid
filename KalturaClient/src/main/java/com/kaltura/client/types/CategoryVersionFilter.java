...
public class CategoryVersionFilter extends CrudFilter {
    ...
    public static final Creator<CategoryVersionFilter> CREATOR = new Creator<CategoryVersionFilter>() {
        @Override
        public CategoryVersionFilter createFromParcel(Parcel source) {
            return new CategoryVersionFilter(source);
        }

        @Override
        public CategoryVersionFilter[] newArray(int size) {
            return new CategoryVersionFilter[size];
        }
    };

    public CategoryVersionFilter(Parcel in) {
        super(in);
    }
}
